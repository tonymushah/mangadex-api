...
const ARGS_MAP = {"mangadex_author":"{\"get_unique\":[\"params\"],\"delete\":[\"id\"],\"list\":[\"params\"],\"create\":[\"params\"],\"edit\":[\"params\"]}","mangadex_api_client":"{\"list\":[\"params\"],\"refresh_secret\":[\"id\"],\"edit\":[\"params\"],\"get_secret\":[\"id\"],\"create\":[\"params\"],\"get_unique\":[\"params\"],\"delete\":[\"params\"]}","mangadex_at_home":"{\"server\":[\"params\"]}","mangadex_auth":"{\"check\":[]}"}
